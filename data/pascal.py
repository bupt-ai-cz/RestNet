...
class DatasetPASCAL(Dataset):
    def __init__(self, datapath, fold, transform, split, shot):
        ...
        self.img_path = os.path.join('/home/user/huangxinyang/CDFSS/PATNet-master/VOCdevkit/VOC2012/JPEGImages/')
        self.ann_path = os.path.join('/home/user/huangxinyang/CDFSS/PATNet-master/VOCdevkit/VOC2012/SegmentationClassAug/')
