...
if __name__ == '__main__':
    ...
    parser.add_argument('--datapath', type=str, default='/home/user/huangxinyang/CDFSS/PATNet-master/testdata/')
    parser.add_argument('--benchmark', type=str, default='fss', choices=['fss', 'isic', 'lung'])
